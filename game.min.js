...
200)};a.draw_icon=function(a){l.clearRect(-400,-400,800,800);100<a.s?(l.drawImage(this.icon,-400,-400,800,800),l.rotate(-this.lightangle),l.drawImage(n,-400,-400,800,800),l.rotate(this.lightangle),c.drawImage(k,a.x-a.s/2,a.y-a.s/2,a.s,a.s)):(l.drawImage(this.s_icon,-50,-50,100,100),l.rotate(-this.lightangle),l.drawImage(p,-50,-50,100,100),l.rotate(this.lightangle),c.drawImage(k,350,350,100,100,a.x-a.s/2,a.y-a.s/2,a.s,a.s))};a.draw_gate=function(a){c.drawImage(this.icon,a.x-a.s/2,a.y-a.s/2,a.s,a.s)};
a.draw_star=function(a){c.beginPath();c.arc(a.x,a.y,2*a.s,0,2*Math.PI);var b=c.createRadialGradient(a.x,a.y,a.s/4,a.x,a.y,2*a.s);b.addColorStop(0,"rgba("+this.color_r+", "+this.color_g+", "+this.color_b+", 0.6)");b.addColorStop(.1,"rgba("+this.color_r+", "+this.color_g+", "+this.color_b+", 0.2)");b.addColorStop(1,"rgba("+this.color_r+", "+this.color_g+", "+this.color_b+", 0.0)");c.fillStyle=b;c.fill();c.drawImage(this.icon,a.x-a.s,a.y-a.s,2*a.s,2*a.s)};a.draw_ship=function(b){c.beginPath();c.moveTo(b.x,
b.y);c.arc(b.x,b.y,this.range/a.zoom,this.rotation-.3,this.rotation+.3);c.lineTo(b.x,b.y);var e=c.createRadialGradient(b.x,b.y,1,b.x,b.y,this.range/a.zoom);e.addColorStop(0,this.color+", 0.4)");e.addColorStop(1,this.color+", 0.0)");c.fillStyle=e;c.fill();g.rotate(this.rotation);g.drawImage(this.icon,-100,-100);g.rotate(-this.rotation);c.drawImage(f,b.x-b.s/2,b.y-b.s/2,b.s,b.s)};a.draw_ripple=function(b){var e=a.translate_coords(b.x,b.y,0);c.strokeStyle="#aadddd";c.beginPath();c.arc(e.x,e.y,b.age,
0,2*Math.PI);c.stroke();b.age+=1};a.draw_trace=function(b){b=a.translate_coords(b.x,b.y);c.fillStyle="#eeeeee";c.fillRect(b.x,b.y,1,1)};a.draw_frame=function(b){for(var e=0;e<b.length;e++){var c=a.translate_coords(b[e].x,b[e].y,b[e].size);c.x>-c.s&&c.x>-c.s&&c.x<d.width+c.s&&c.y<d.height+c.s&&b[e].draw(c)}}})(window.FX=window.FX||{});(function(){var a=0,d=["ms","moz","webkit","o"],c;for(c=0;c<d.length&&!window.requestAnimationFrame;c++)window.requestAnimationFrame=window[d[c]+"RequestAnimationFrame"],window.cancelAnimationFrame=window[d[c]+"CancelAnimationFrame"]||window[d[c]+"CancelRequestAnimationFrame"];window.requestAnimationFrame||(window.requestAnimationFrame=function(e,b){var c=(new Date).getTime(),d=Math.max(0,16-(c-a)),g=window.setTimeout(function(){e(c+d)},d);a=c+d;return g});window.cancelAnimationFrame||(window.cancelAnimationFrame=
...
d.mass*c.mass/(h*h)*h/c.mass);.5<=Math.random()?(c.vx=d.vx+b*f/h,c.vy=d.vy-e*f/h):(c.vx=d.vx-b*f/h,c.vy=d.vy+e*f/h)}})(window.PHYS=window.PHYS||{});(function(a){var d=Math.random,c=function(a){this.mass<a.mass||(this.vx+=a.mass/(a.mass+this.mass)*a.vx,this.vy+=a.mass/(a.mass+this.mass)*a.vy,this.mass+=a.mass,this.size+=Math.sqrt(a.size)/2,a.dying=!0,a.mass=0)},e=function(a){var c=Math.atan2(a.y-this.y,a.x-this.x);0>c&&(c+=2*Math.PI);c>this.rotation-.3&&c<this.rotation+.3?"check"==a.type?(this.color="rgba(150, 230, 150",a.size-=5,10>a.size&&(document.getElementById("messages").innerHTML="Checkpoint cleared!",a.dead=!0)):this.color="rgba(230, 150, 150":
this.color="rgba(200, 200, 200"};a.node=function(a,c,d,e,k){this.type="node";this.x=a;this.y=c;this.vx=e;this.vy=k;this.mass=d;this.size=100;this.draw=function(){};this.oncontact=function(){};this.range=0;return this};a.planet=function(b,e,f,g,k){b=new a.node(b,e,f,g,k);b.type="planet";b.icon=new Image;b.s_icon=new Image;e=Math.floor(6*d())+".png";b.icon.src="img/planet"+e;b.s_icon.src="img/s_planet"+e;b.draw=FX.draw_icon;b.size=2*Math.sqrt(f);b.farlight=Infinity;b.lightangle=0;b.oncontact=c;b.range=
2*b.size/3;return b};a.star=function(b,e,f,g,k){b=new a.node(b,e,f,g,k);b.type="star";b.color_r=100+Math.floor(150*d());b.color_g=100+Math.floor(150*d());b.color_b=100+Math.floor(150*d());b.icon=new Image;b.icon.src="img/star.png";b.draw=FX.draw_star;b.size=2*Math.sqrt(f);b.oncontact=c;b.range=b.size/2;return b};a.ship=function(b,c,d,g,k){b=new a.node(b,c,d,g,k);b.type="ship";b.icon=new Image;b.icon.src="img/rocket.png";b.rotation=-Math.PI/4;b.thrust=0;b.draw=FX.draw_ship;b.range=1E3;b.oncontact=
e;b.color="rgba(200, 200, 200";return b};a.check=function(b,c,e,g){b=new a.node(b,c,1,e,g);b.type="check";b.icon=new Image;c=Math.floor(4*d())+".png";b.icon.src="img/asteroid"+c;b.draw=FX.draw_gate;b.frame=0;b.size=128;return b}})(window.ACTS=window.ACTS||{});(function(a){a.nodes=[];a.masscount=0;a.shipindex=0;var d=Math.random,c=function(a){return Math.round(Math.random()*a)};a.init_world=function(){a.nodes=[];a.nodes.push(new ACTS.star(0,0,3E5,0,0));a.nodes.push(new ACTS.planet(c(1600)+1600,c(1600)+1600,1E4,0,0));a.shipindex=a.nodes.length;a.nodes.push(new ACTS.ship(a.nodes[1].x+200,a.nodes[1].y-220,1,0,0));PHYS.orbit(a.nodes[0],a.nodes[1]);PHYS.orbit(a.nodes[1],a.nodes[2]);a.masscount=a.shipindex;for(var e=0;5>e;e++)a.add_checkpoint()};a.end=function(a){cancelAnimationFrame(window.frameId);
document.getElementById("messages").innerHTML="<p>"+a+"</p>";document.getElementById("log").className="extended"};a.add_checkpoint=function(){var d=a.nodes.length;a.nodes.push(new ACTS.check(c(3200)-1600,c(3200)-1600,0,0));PHYS.orbit(a.nodes[0],a.nodes[d])};a.add_random_object=function(){.7<d()?a.nodes.push(new ACTS.star(6400*d()-3200,6400*d()-3200,1E4+5E5*d(),100*d()-50,100*d()-50)):a.nodes.push(new ACTS.planet(6400*d()-3200,6400*d()-3200,1E3+1E4*d(),100*d()-50,100*d()-50))};a.clear_dead=function(){for(var c=
[],b=0,d=0;d<a.nodes.length;d++){var f=a.nodes[d];f.dying&&(f.size/=2,10>f.size&&(f.dead=!0,"star"!=f.type&&"planet"!=f.type||a.masscount--,"ship"==f.type&&a.end("Your ship was destroyed. Oops?")));f.dead||("ship"==f.type&&(a.shipindex=c.length),"check"==f.type&&b++,c.push(f))}0==b&&a.end("All checkpoints cleared. Congratulations!");a.nodes=c}})(window.LVL=window.LVL||{});var fpscount=document.getElementById("fps"),objcount=document.getElementById("objcount"),messages=document.getElementById("messages"),ripples=[],traces=[],dt,nextDT;window.frameId=NaN;
